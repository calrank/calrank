...
마라톤·자전거·트레일러닝·철인3종·하이록스 등 국내 동호인 스포츠 대회 정보를 여러 소스에서 자동으로 수집해 한 곳에서 보여주는 정적 사이트입니다. Vercel에 배포되어 있으며 (`calrank.vercel.app`), GitHub Actions가 주기적으로 크롤링·데이터 갱신을 담당합니다.
